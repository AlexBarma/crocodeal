                        ...
                        <div class="col-xl-12">
                            ...
                            <form class="form-horizontal" id="postForm" method="POST"
                                ...
                                <fieldset>
                                    ...
                                    : '';
                                    $countryCodeValue = (!empty(config('ipCountry.code'))) ? config('ipCountry.code') :
                                    0;
                                    ...
                                    $authFieldValue = ($usersCanChooseNotifyChannel) ? (old('auth_field',
                                    getAuthField())) : getAuthField();
                                    @endphp
                                    @if ($usersCanChooseNotifyChannel)
                                    <div class="row mb-3 required">
                                        <label class="col-md-3 col-form-label" for="auth_field">{{
                                            t('notifications_channel') }} <sup>*</sup></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row mb-3 auth-field-item required{{ $forceToDisplay }}">
                                        <label class="col-md-3 col-form-label{{ $emailError }}" for="email">{{
                                            t('email') }}
                                    ...
                                    $phoneValueOld = phoneE164(old('phone', $phoneValue), old('phone_country',
                                    $phoneCountryValue));
                                    @endphp
                                    <div class="row mb-3 auth-field-item required{{ $forceToDisplay }}">
                                        <label class="col-md-3 col-form-label{{ $phoneError }}" for="phone">{{
                                            t('phone_number') }}
                                    ...
                                    <div class="row mb-3 required">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-text text-muted">{{ t('You will receive your authentication
                                                information by email') }}</div>
                                        </div>
                                    </div>
                                    @else
                                    ...
                                    @include('layouts.inc.tools.captcha', ['colLeft' => 'col-md-3', 'colRight' =>
                                    'col-md-8'])
                                    ...
                                    @php
                                    $acceptMarketingOffersError = (isset($errors) &&
                                    $errors->has('accept_marketing_offers')) ? ' is-invalid' : '';
                                    $acceptMarketingOffers = old('accept_marketing_offers', data_get($postInput,
                                    'accept_marketing_offers'));
                                    @endphp
                                    <div class="row mb-3 required">
                                        <label class="col-md-3 col-form-label"></label>
                                    ...
                                    <div class="row mb-3 pt-3">
                                        <div class="col-md-12 text-center">
                                            <button id="nextStepBtn" class="btn btn-primary btn-lg">{{ t('Next')
                                                }}</button>
                                        </div>
                                    </div>
