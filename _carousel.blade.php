<!--C:\OSPanel\domains\crocodeal.org\resources\views\search\inc\posts\widget\carousel.blade.php-->
@php
	$widget ??= [];
							...
							@foreach($posts as $key => $post)
								<div class="item">
									<a href="{{ \App\Helpers\UrlGen::post($post) }}">
										<!--Сделана голубая рамка для списка объявлений-->
										<span 
										style="border: 3px solid;
										border-radius: 12px;"  
										class="item-carousel-thumb">
